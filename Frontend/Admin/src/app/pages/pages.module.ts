...
@NgModule({
  declarations: [CalendarComponent, AttendanceComponent, ClassComponent, ClassDetailComponent, SettingAttendanceComponent, QrAttendanceComponent, GeneratePointComponent, ClassPointComponent, CreatePointFormComponent],
  imports: [
    CommonModule,
    FormsModule,
    NgbDropdownModule,
